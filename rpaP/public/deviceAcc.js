...
var ctx1 = document.getElementById('chartGyr');
...
var valueGX = document.getElementById('valueGX');
var valueGY = document.getElementById('valueGY');
var valueGZ = document.getElementById('valueGZ');
socketAcc.on('nano33', function (data) {
  console.log(data);
