...
var _equipment = require("../controllers/equipment.controllers");
...
var queries = {
  ...
  createNotice: 'INSERT INTO notices(status, machine, message, regtime, requester) VALUES (@status, @machine, @message, @regtime, @requester)',
